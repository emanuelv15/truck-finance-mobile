...
export default class EditProfit extends Component {
  ...
  async componentDidMount() {
    ...
    await this.setState({
      name: truck.profits[index].name,
      description: truck.profits[index].description,
      value: truck.profits[index].value,
      date: truck.profits[index].date,
    });
  }
  ...
  saveFinance = async () => {
    ...
    realm.then((realm) => {
      realm.write(() => {
        ...
        truck.profits[index].name = name;
        truck.profits[index].description = description;
        truck.profits[index].value = value;
        truck.profits[index].date = date;
      });
    });
  };
